...
public class Customer {
	...
	@Column(nullable=false, length=15)	@Size(min=2, max=225) @NotNull	private String title;
	@Column(nullable=false, length=100)	@Size(min=3, max=25) @NotNull private String name;
